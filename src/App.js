...
import Headless from './modals/headless';
            ...
            <BrowserRouter>
                <Routes>
                    <Route path="/" element={<div>
                        ...
                        <Link to="/headless">Headless UI</Link>
                        <Link to="/own-without-block">Own Without Block</Link>
                        <Link to="/own-with-block">Own Without Block</Link>
                    </div>} />
                    ...
                    <Route path="/headless" element={<div><Background render={(open, onClose) => <Headless open={open} onClose={onClose} />} name="Headless" /></div>} />
